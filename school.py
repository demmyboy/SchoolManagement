    ...
    def __init__(self, root):
        ...
        def addData():
            if student_id.get() == "" or first_name.get() == "" or last_name.get()=="":
                tkinter.messagebox.askyesno("International Business Program", "Name is mandatory ")
            else:
                sqlCon = pymysql.connect(host='localhost', user='root', password='Ck')
